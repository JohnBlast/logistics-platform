...
export const LOAD_FIELDS: FieldDef[] = [
  ...
  { name: 'accepted_quote_id', type: 'UUID', required: false, description: 'Quote that was accepted for this load' },
  { name: 'load_poster_name', type: 'VARCHAR', required: true, description: 'Name of person who posted the load' },
  { name: 'allocated_fleet_id', type: 'UUID', required: false, description: 'Fleet assigned to the load' },
