    ...
    <div className="absolute bottom-3 left-3 z-[1000] bg-white/90 backdrop-blur-sm rounded border border-black/12 px-3 py-2 text-xs space-y-1.5 shadow-sm">
      ...
      {showLoads && (
        <>
          ...
          <div className="flex items-center gap-2">
            <span className="inline-flex items-center justify-center w-4 h-5 text-[8px] font-bold" style={{ color: '#2e7d32' }}>
              <svg width="14" height="18" viewBox="0 0 14 18"><path d="M7 0C3.1 0 0 3.1 0 7c0 5.25 7 11 7 11s7-5.75 7-11c0-3.9-3.1-7-7-7z" fill="#2e7d32" stroke="#fff176" strokeWidth="1.5"/><text x="7" y="10" textAnchor="middle" fill="white" fontSize="8" fontWeight="bold">C</text></svg>
            </span>
